...
<html lang="en">
  ...
  <body style="background:url('images/6.jpg'); background-size: cover;">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              <center>
              <h5>Fitness Admin Login</h5><br>
              <form class="form-group" method="POST" action="admin-panel.php"style="background-color:orange;">
                <div class="row"style="padding-top:20px;padding-right:15px;">
